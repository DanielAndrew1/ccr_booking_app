...
class CustomAlertDialogue extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoAlertDialog(
      ...
      content: Text(loc.tr(body), style: TextStyle(fontSize: 14)),
      actions: [
        CupertinoDialogAction(
          child: Text(loc.tr("Cancel"), style: TextStyle(color: Colors.blue)),
          onPressed: () => Navigator.pop(context, false),
        ),
        CupertinoDialogAction(
          child: Text(loc.tr(confirm), style: TextStyle(color: AppColors.red)),
