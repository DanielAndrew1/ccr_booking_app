...
class CustomSnackBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool showTick = isSuccess || backgroundColor == AppColors.green;
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            _DelayedSnackBarIcon(showTick: showTick),
...
class _DelayedSnackBarIcon extends StatefulWidget {
  final bool showTick;

  const _DelayedSnackBarIcon({required this.showTick});

  @override
  State<_DelayedSnackBarIcon> createState() => _DelayedSnackBarIconState();
}

class _DelayedSnackBarIconState extends State<_DelayedSnackBarIcon> {
  bool _show = false;
  ...
  Widget build(BuildContext context) {
    return AnimatedScale(
      ...
      child: SvgPicture.asset(
        widget.showTick ? AppIcons.tick : AppIcons.info,
        color: Colors.white,
        width: 32,
      ),
    );
